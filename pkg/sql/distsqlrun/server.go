...
func NewServer(ctx context.Context, cfg ServerConfig) *ServerImpl {
	...
	if err := os.RemoveAll(cfg.RocksDBPath); err != nil {
	...
	if err := os.Mkdir(cfg.RocksDBPath, 0700); err != nil {
...
func (ds *ServerImpl) setupFlow(
	...
	f := newFlow(flowCtx, ds.flowRegistry, syncFlowConsumer, ds.processorRegistry)
